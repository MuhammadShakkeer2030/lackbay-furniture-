    ...
    <div className="bg-gray-100 p-6 md:p-10 lg:p-16">
      <div className="max-w-5xl mx-auto">
        <div className="text-center">
          <h2 className="text-[14px] md:text-[14px] font-bold mb-4 text-[#006e63]">Lacbay</h2>
        ...
        <div className="mt-10 md:mt-16 lg:mt-20 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-[14px] font-bold mb-4 text-[#006e63] ">Vision</h3>
            <p className="text-gray-600">
          ...
          <div>
            <h3 className="text-[14px] font-bold mb-4 text-[#006e63]">Mission</h3>
            <p className="text-gray-600">
        ...
        <div className="mt-10 md:mt-16 lg:mt-20">
          <h3 className="text-[14px] font-bold mb-4 text-[#006e63]">Business & Ethics</h3>
          <p className="text-gray-600">
          ...
          <img src="/images/busi4.jpg" alt="" className='h-[600px]'/>
        </div>

        <div className="mt-10 md:mt-16 lg:mt-20">
          <h3 className="text-[14px] font-bold mb-4 text-[#006e63]">Quality Process</h3>
          <p className="text-gray-600">
         ...
         <img src="/images/sofa.jpg" alt="sofa.jpg" className='w-[500px] object-contain' />
          <img src="/images/wood4.jpg" alt="wood4.jpg" className='w-[500px] object-contain'/>
         </div>
        </div>
      </div>
    </div>
